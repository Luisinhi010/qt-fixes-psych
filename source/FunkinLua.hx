...
class FunkinLua
{
	...
	// public var needsValue3:Bool; // pull: https://github.com/ShadowMario/FNF-PsychEngine/pull/10713
	// the var got unused, since, you know, you can code if value 3 will do something
	#if hscript
