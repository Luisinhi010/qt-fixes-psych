...
class CharacterEditorState extends MusicBeatState
{
	...
	override function create()
	{
		...
		healthBarBG = new FlxSprite(30, FlxG.height - 75).loadGraphic(Paths.image('luis/qt-fixes/healthBar'));
		...
		var templateCharacter:FlxButton = new FlxButton(140, 50, "Load Template", function()
		{
			...
			for (character in characters)
			{
				...
				for (anim in character.animationsArray)
				{
					...
					character.addCamOffset(anim.anim, 0, 0);
				}
				...
				character.splashSkinFile = parsedJson.splashSkin;
	...
	function addCharacterUI()
	{
		...
		imageInputText = new FlxUIInputText(15, 20, 200, 'characters/BOYFRIEND', 8);
		var reloadImage:FlxButton = new FlxButton(imageInputText.x + 210, imageInputText.y - 16, "Reload Image", function()
		{
		...
		splashSkinInputText = new FlxUIInputText(noteSkinInputText.x, noteSkinInputText.y + 35, 80, 'noteSplashes', 8);

		singDurationStepper = new FlxUINumericStepper(15, splashSkinInputText.y + 35, 0.1, 4, 0, 999, 1);
		...
		tab_group.add(new FlxText(noteSkinInputText.x, noteSkinInputText.y - 18, 0, 'Note skin file name:'));
		tab_group.add(new FlxText(splashSkinInputText.x, splashSkinInputText.y - 18, 0, 'Note Splash skin file name:'));
	...
	function addAnimationsUI()
	{
		...
		animationInputText = new FlxUIInputText(10, 80, 80, '', 8);
		animationNameInputText = new FlxUIInputText(animationInputText.x, animationInputText.y + 30, 150, '', 8);
		animationIndicesInputText = new FlxUIInputText(animationNameInputText.x, animationNameInputText.y + 40, 250, '', 8);
		animationNameFramerate = new FlxUINumericStepper(animationInputText.x + 170, animationInputText.y, 1, 24, 0, 240, 0);
		animationLoopCheckBox = new FlxUICheckBox(animationNameInputText.x + 170, animationNameInputText.y - 1, null, null, "Should it Loop?", 100);

		animationDropDown = new FlxUIDropDownMenuCustom(10, animationInputText.y - 50, FlxUIDropDownMenuCustom.makeStrIdLabelArray([''], true),
			function(pressed:String)
			{
		...
		var removeButton:FlxButton = new FlxButton(180, animationIndicesInputText.y + 30, "Remove", function()
		{
			for (anim in char.animationsArray)
			{
				if (animationInputText.text == anim.anim)
				{
					...
					if (char.camOffset.exists(anim.anim))
						char.camOffset.remove(anim.anim);
	...
	override function getEvent(id:String, sender:Dynamic, data:Dynamic, ?params:Array<Dynamic>)
	{
		if (id == FlxUIInputText.CHANGE_EVENT && (sender is FlxUIInputText))
		{
			if (sender == healthIconInputText)
			{
				...
				char.splashSkinFile = splashSkinInputText.text;
		}
		else if (id == FlxUINumericStepper.CHANGE_EVENT && (sender is FlxUINumericStepper))
		{
			...
			else if (sender == animPositionCameraXStepper)
			{
			}
			else if (sender == animPositionCameraYStepper)
			{
			}
	...
	function reloadCharacterOptions()
	{
		if (UI_characterbox != null)
		{
			...
			splashSkinInputText.text = char.splashSkinFile;
	...
	function updatePresence()
	{
		...
		DiscordClient.changePresence("Character Editor", "Character: " + daAnim, leHealthIcon.getDiscordCharacter());
		#end
	}
	...
	function saveCharacter()
	{
		var json = {
			...
			"splashSkin": char.splashSkinFile
		};
